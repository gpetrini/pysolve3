' macro for shocking propensity to save
'
' discussion on the paradox of thrift, par 3.1 in the text
...
' a_model.append UR = ((ur(-1)-(n/n(-1)-1-ngr0)/pokun)<0)*0+((ur(-1)-(n/n(-1)-1-ngr0)/pokun)>0)*(ur(-1)-(n/n(-1)-1-ngr0)/pokun)
